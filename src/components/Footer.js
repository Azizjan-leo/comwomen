...
function Footer() {
  return (
    ...
    <div className="col-lg-3 col-md-6 col-sm-6 col">
      ...
      <p className="mb10 footer-description">Это первая и самая крупная женская организация в демократическом Кыргызстане, которое охватывает все регионы республики.  Более  20,00 тысяч женщин является членами КЖ КР.</p>
